...
from imagination import utils


CONF = cfg.CONF

_CTX_THREAD_LOCAL_NAME = "IMAGINATION_APP_CTX_THREAD_LOCAL"
...
class ImaginationContext(BaseContext):
    ...
    def __repr__(self):
        return "ImaginationContext %s" % self.to_dict()
...
class RpcContextSerializer(messaging.Serializer):
    ...
    def deserialize_context(self, context):
        ctx = ImaginationContext(**context)
        set_ctx(ctx)
